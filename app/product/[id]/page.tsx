              ...
              <div className="w-full flex flex-col items-center">
                ...
                <div className="flex flex-col gap-0 w-full border border-[#0F1824] mb-4">
                  <button
                    ...
                    className={`w-full py-4 text-sm font-medium transition-colors flex items-center justify-center gap-2 ${
                    ...
                    disabled={!selectedSize || (product.sizeVariants && !selectedColor) || isSoldOut || isSelectedVariantSoldOut() || addingToCart}
                  >
                    {addingToCart ? (
                      <>
